...
export default function Footer() {
  return (
    <footer className="text-base lg:pt-8 bg-background">
      <div className="w-full max-w-screen-xl p-4 mx-auto bg-background">
        <div className="md:flex md:justify-between">
          <div className="pb-4 pt-4 md:pt-0 md:m-4 mt-0 mb-8 ml-0 md:mr-10 obs-hidden md:mb-0 lg:mr-20">
            <a href="#start" className="flex justify-center">
              <Image
                width={184}
                src={Logo}
                className="duration-300 ease-in-out grayscale hover:grayscale-0"
                alt="Logo do Manchester Healthcare"
              />
            </a>
          </div>
          <div className="grid grid-cols-1 gap-8 text-center sm:grid-cols-2 sm:gap-6 md:w-10/12 md:grid-cols-3 md:gap-10 md:text-left lg:grid-cols-[1.5fr,2fr,1fr]">
            <div className="obs-hidden" style={{ ["--delay" as any]: 3 }}>
              <h2 className="mb-6 text-lg font-bold font-heading text-text uppercase">
                Contato
              </h2>
              <ul className="text-text">
                <li className="flex justify-center mb-4 transition-colors md:justify-start">
                  <a
                    href="mailto:mhccare@gmail.com"
              ...
              <ul className=" text-text">
                <li className="mb-4">
                  <a
                    ...
                    className="duration-300 ease-in-out hover:text-text hover:underline"
                  >
                    <p>Augusto Barcelos Barros - 98078</p>
                ...
                <li className="mb-4">
                  <a
                    ...
                    className="duration-300 ease-in-out hover:text-text hover:underline"
                  >
                    <p>Gabriel Gribl de Carvalho - 96270</p>
                    {/* <p>(Diretor de Projetos e Inovação)</p> */}
                  </a>
                </li>
                <li className="mb-4">
                  <a
                    ...
                    className="duration-300 ease-in-out hover:text-text hover:underline"
                  >
                    <p>Gabriel Souza de Queiroz - 98570</p>
                    {/* <p>(Diretor Adm. Financeiro)</p> */}
                  </a>
                </li>
                <li>
                  <a
                    ...
                    className="duration-300 ease-in-out hover:text-text hover:underline"
                  >
                    <p>Gabriela Zanotto Alves Rodrigues - 551629</p>
                    {/* <p>(Diretora de Marketing e Vendas)</p> */}
                  </a>
                </li>
              </ul>
            </div>
            <div className="obs-hidden" style={{ ["--delay" as any]: 9 }}>
              ...
              <ul className="flex flex-col  gap-y-4 text-text">
                <li>
                  <Link
                    className="duration-300 ease-in-out hover:text-text hover:underline"
                    href="/"
        ...
        <div className="flex flex-wrap justify-center sm:justify-between items-center text-center gap-x-6">
          <div className="flex justify-center py-3 mt-2 text-base text-text bg-cinza-escuro">
            <a
              id="copyright"
              target="_blank"
